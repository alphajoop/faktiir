...
export const metadata = constructMetadata({
  ...
  description:
    'Créez des factures professionnelles en quelques minutes avec Faktiir. Solution simple, rapide et adaptée au marché africain. Essai gratuit.',
});

export default function LandingPage() {
  // Schémas JSON-LD pour le SEO
  const productSchema = generateFaktiirProductSchema({
    name: 'Faktiir Premium',
    description:
      'Solution de facturation illimitée pour freelances et petits commerçants',
    price: '2000',
  });

  const serviceSchema = generateFaktiirServiceSchema({
    name: 'Création de factures professionnelles',
    description:
      'Générez des factures PDF personnalisées avec logo et suivi des paiements',
  });
            ...
            >
              <div className="mx-auto max-w-6xl px-4">
                ...
                <p className="text-muted-foreground mx-auto mt-4 max-w-2xl text-center">
                  Une solution complète pour gérer votre facturation au
                  quotidien
                </p>
            ...
            >
              ...
              <div className="relative z-10 mx-auto max-w-6xl px-4 text-center">
                ...
                <p className="text-muted-foreground mx-auto mt-4 max-w-xl">
                  Rejoignez des centaines de freelances qui utilisent déjà
                  Faktiir
                </p>
